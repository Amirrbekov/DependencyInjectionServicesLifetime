...
namespace DI_Service_Lifetime.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IScopedGuidService scoped1, IScopedGuidService scoped2, ITransientGuidService transient1, ITransientGuidService transient2, ISingletonGuidService singleton1, ISingletonGuidService singleton2)
        {
            _scoped1 = scoped1;
            _scoped2 = scoped2;
